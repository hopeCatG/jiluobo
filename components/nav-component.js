    ...
    this.innerHTML = `
      <nav>
        <ul id="menu_top_menu" class="">
          ...
          <li class="${currentPath === '/services' ? 'active current' : ''}"><a href="/services" class="services-title-class" title="Services" aria-label="Services" id="menu_1" aria-labelledby="menu_1">服务</a></li>
          <li class="${currentPath === '/network' ? 'active current' : ''}"><a href="/network" class="network-title-class" title="Network" aria-label="Network" id="menu_2" aria-labelledby="menu_2">网络</a></li>
          ...
          <li class="dropdown ${this.isDropdown(currentPath, ['/governance', '/anti-corruption-policy', '/human-rights-policy', '/integrated-policy-environment-safety-health', '/social-responsibility-policy', '/code-of-ethics']) ? ' current' : ''}"><a href="/governance" class="governance-title-class" title="Governance" aria-label="Governance" id="menu_4" aria-labelledby="menu_4"> 治理</a>
            <ul class="dropdown-menu">
              ...
              <li class="${currentPath === '/human-rights-policy' ? 'active current' : ''}"><a href="/human-rights-policy" class="governance-human_rights_policy-title-class" title="Human Rights Policy" aria-label="Human Rights Policy" id="menu_6" aria-labelledby="menu_6"> 人权政策</a></li>
          ...
          <li class="${currentPath === '/sustainability' ? 'active current' : ''}"><a href="/sustainability" class="sustainability-title-class" title="Sustainability" aria-label="Sustainability" id="menu_10" aria-labelledby="menu_10"> 可持续性</a></li>
