    ...
    this.innerHTML = `
      <nav>
        <ul id="menu_top_menu" class="">
          ...
          <li class="${currentPath === '/news' ? 'active current' : ''}"><a href="/news" class="network-title-class" title="Network" aria-label="Network" id="menu_2" aria-labelledby="menu_2">公司动态</a></li>
